...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=20, kernel_size=(3,3), stride=1, padding=0)
        self.conv3 = nn.Conv2d(in_channels=20, out_channels=3, kernel_size=(3,3), stride=10, padding=0)
...
output = torch_onnx.export(model, 
                          ...
                          verbose=True,do_constant_folding=False,training=torch.onnx.TrainingMode.TRAINING)
model.eval()
