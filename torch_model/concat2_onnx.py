...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=3, out_channels=16, kernel_size=(3,3), stride=1, padding=0)
    ...
    def forward(self, inputs):
        ...
        #x1 = self.conv2(y)
        #x2 = self.conv3(y)
        [x1,x2,x3,x4]=torch.split(y,[16,16,16,16],dim=1)
        a=torch.cat((x1,x2),dim=1)
        b=torch.cat((x3,x4,y2),dim=1)
